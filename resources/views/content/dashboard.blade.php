...
@section('content')
    <div class="row">
        ...
        <div class="col-lg-7 pl-3 pt-2 pb-2 pr-2"
            style="background-image: url(assets/main.png) !important; background-size: 80% ; background-repeat: no-repeat; background-position: 15rem -5rem">
                    ...
                    <div class="card border-warning-light m-4 p-2 bg-warning-light shadow-sm">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item bg-warning-light">
                                ...
                                <p>
                                    Here are some basic steps you can take to improve your sales performance, reduce your
                                    cost of selling, and ensure your great business.
                                </p>
